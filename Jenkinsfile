                ...
                script {
                    if (params.DEPLOY_TO_PROD && env.BRANCH_NAME == 'main') {
                        ...
                        sh """
                            ...
                            # Supprimer toutes les ressources par label
                            kubectl delete all -l app.kubernetes.io/name=movie-service -n prod --ignore-not-found=true --wait=false
                            kubectl delete all -l app.kubernetes.io/name=cast-service -n prod --ignore-not-found=true --wait=false
                            kubectl delete serviceaccount -l app.kubernetes.io/name=movie-service -n prod --ignore-not-found=true --wait=false
                            kubectl delete serviceaccount -l app.kubernetes.io/name=cast-service -n prod --ignore-not-found=true --wait=false
                            
                            # Supprimer aussi par nom au cas où
                        ...
                        sh """
                            ...
                            # Supprimer toutes les ressources par label
                            kubectl delete all -l app.kubernetes.io/name=movie-service -n ${params.ENVIRONMENT} --ignore-not-found=true --wait=false
                            kubectl delete all -l app.kubernetes.io/name=cast-service -n ${params.ENVIRONMENT} --ignore-not-found=true --wait=false
                            kubectl delete serviceaccount -l app.kubernetes.io/name=movie-service -n ${params.ENVIRONMENT} --ignore-not-found=true --wait=false
                            kubectl delete serviceaccount -l app.kubernetes.io/name=cast-service -n ${params.ENVIRONMENT} --ignore-not-found=true --wait=false
